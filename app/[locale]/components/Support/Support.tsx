...
export const Support: FC<LocaleProps> = async ({ locale }) => {
  ...
  return (
    <Section className="bg-blue-600">
      <Container className="mg:grid-cols-[336px_1fr] grid gap-[60px] md:gap-7 xl:grid-cols-[426px_1fr] xl:gap-[74px] 2xl:grid-cols-[600px_1fr]">
        ...
        <div className="rounded bg-zinc-50 px-7 py-5 2xl:px-10">
          <Tabs />
        </div>
      </Container>
    </Section>
