...
export const Hero: FC<LocaleProps> = async ({ locale }) => {
  ...
  return (
    <Section
      className="bg-gradient-to-b from-yellow-400 from-[56.6%] to-zinc-50 to-[56.6%] md:bg-gradient-to-r md:from-[56.6%] md:to-[56.6%] lg:from-[55%] lg:to-[55%] xl:from-[52.4%] xl:to-[52.4%] 2xl:from-[51.8%] 2xl:to-[51.8%]"
      variant="custom"
      fixedWith
    >
