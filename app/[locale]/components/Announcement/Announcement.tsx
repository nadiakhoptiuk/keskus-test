...
export const Announcement: FC<LocaleProps> = async ({ locale }) => {
  ...
  return (
    <Section>
      <Container className="decorBorderBottom grid-areas-announcementSm md:grid-areas-announcementMd xl:grid-areas-announcementXl md:grid-cols-announcementMd  xl:grid-cols-announcementXl grid-cols-announcementSm grid-rows-announcementSm md:grid-rows-announcementMd xl:grid-rows-announcementXl relative grid xl:gap-x-[78px] ">
