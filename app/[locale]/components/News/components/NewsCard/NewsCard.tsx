  ...
  return (
    <li>
      ...
      <div className="grid gap-y-4 pt-5">
        ...
        <Typography className="line-clamp-5">{description}</Typography>

        <Link
          className="baseTransition ml-auto inline-flex items-center gap-x-1 hover:text-blue-600 focus:text-blue-600"
          href={link}
        >
